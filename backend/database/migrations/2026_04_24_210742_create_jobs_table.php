...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('jobs', function (Blueprint $table) {
            ...
            // Ubicación estructurada — reemplaza el campo genérico "zone"
            $table->string('provincia', 100);                                  // Ej: "Panamá", "Chiriquí"
            $table->string('distrito', 100);                                   // Ej: "San Francisco", "David"

            // Coordenadas opcionales (útiles para mostrar en mapa al técnico)
